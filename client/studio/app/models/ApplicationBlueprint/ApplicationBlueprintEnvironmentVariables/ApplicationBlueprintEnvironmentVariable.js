class ApplicationBlueprintEnvironmentVariable {

  constructor( environmentVariables, object, id ) {
  ...
  delete() {
    this.environmentVariables.delete( this.id )
  }
  ...
  formSubmit( formObject ) {
    ...
    if ( this.isNew ) this.environmentVariables.create( this )
  }
