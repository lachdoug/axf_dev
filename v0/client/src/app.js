...
//  		a.button( "Go to #1", { onclick: function () { controller._open("/people/1") } } ),
//  		a.button( "Go to #2", { onclick: function () { controller._open("/people/2") } } ),
//  		a.button( "Joanna", { onclick: function () { controller._open("/joanna") } } ),
//  	],
//  	"/joanna": "Joanna",
//  	"/people/:id": ( params, controller ) => [
//  		a.button( "<", { onclick: function () { controller._open( "/people" ) } } ),
//  		a.button(
//  			"Edit #" + params.id,
//  			{ onclick: function () {
//  					controller._open( "/people/" + params.id + "/edit" )
//  			} }
//  		),
//  	],
...
//  		{ cancel: [ "Cancel", function() { controller._open("/people/" + params.id) }, { style: "color: blue;"} ] }
//  	) },
//  	{
// 		root: "/people",
//  		bind: "#people-router",
// 		default: ( controller ) => a.button("Home", { onclick: function() { controller._open("/") } })
//  	}
//  );
// };
//
...
// 	return x.controller(
// 		{
// 			'/': ( params, controller ) => a.button("Read", { onclick: function() { controller._open("/detail") } }),
// 			'/detail': ( params, controller ) => a.button("<", { onclick: function() { controller._open("/") } } )
// 			},
// 		{ bind: "#news-router"}
//   )
// };
