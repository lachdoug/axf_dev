// var $xxx = { $cell :true, $text: "hi", id: "xxx" }

ax( (a,x) => [
	x.controller( { bind: "window" } ),
	appStyles(a,x),
	appHeader(a,x),
	appBody(a,x),
	appFooter(a,x)
...
// 	return x.views( {
//  	"/people": ( params, cell ) => [
//  		a.button( "Go to #1", { onclick: function () { cell._open("/people/1") } } ),
//  		a.button( "Go to #2", { onclick: function () { cell._open("/people/2") } } ),
//  		a.button( "Joanna", { onclick: function () { cell._open("/joanna") } } ),
//  	],
//  	"/joanna": "Joanna",
//  	"/people/:id": ( params, cell ) => [
//  		a.button( "<", { onclick: function () { cell._open( "/people" ) } } ),
//  		a.button(
//  			"Edit #" + params.id,
//  			{ onclick: function () {
//  					cell._open( "/people/" + params.id + "/edit" )
//  			} }
//  		),
//  	],
//  	"/people/:id/edit": ( params, cell ) => x.requestform(
...
//  		{ cancel: [ "Cancel", function() { cell._open("/people/" + params.id) }, { style: "color: blue;"} ] }
//  	) },
//  	{
// 		root: "/people",
//  		bind: "#people-controller",
// 		default: (cell) => a.button("Home", { onclick: function() { cell._open("/") } })
//  	}
//  );
// };
//
...
// 	return x.views(
// 		{
// 			'/': ( params, cell ) => a.button("Read", { onclick: function() { cell._open("/detail") } }),
// 			'/detail': ( params, cell ) => a.button("<", { onclick: function() { cell._open("/") } } )
// 			},
// 		{ bind: "#news-controller"}
//   )
// };
//
...
// 	x.controller( { id: "people-controller", root: "/people/2", bind: "window" } ),
// 	x.controller( { id: "news-controller" } ),
// 	peopleViews(a,x),
// 	a.hr(),
// 	peopleViews(a,x),
// 	a.hr(),
