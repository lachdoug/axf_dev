AxBuilderExtensionsFormBuilder.prototype.dependentfield = function(
  field,
  fieldName,
  options
) {
    ...
    dependentFieldGeneOptions = Object.assign(
      dependentFieldGeneOptions,
      {
        ...
        _dependentMatch: function() {
          // debugger
          var dependentOnField = document.querySelector( dependentFieldBuilderOptions.selector );
          if ( dependentOnField ) {
            // debugger
            ...
            console.error( "AxError: failed to find dependent field with selector " + dependentFieldBuilderOptions.selector );
            return false;
          };
        },
