AxBuilderExtensionsFormBuilder.prototype.field = function(
  fieldName,
  fieldTypeOrOptions,
  fieldValueOrOptions,
  options
  ...
  var x = cellBuilder.extensionsBuilder;
  var f = this;
...
// debugger;
  ...
  // options.id = options.id || "field_" + x.lib.nameKeys( fieldName ).join("_");
...
options.id = options.id || axNextUniqueId();
  ...
  var attributes = Object.assign(
    {
      ...
      _fieldChanged: function() {
        var nodes = this.closest("form") ? this.closest("form").querySelectorAll('dependentfield') : [];
        nodes.forEach( function( node ) {
          node._checkDependentField();
        } );
        // if ( options.dependent ) {
        //   return this.querySelector("dependentfield")._fieldChanged();
        // };
      },
      _dependentMatch: function() {
        // debugger;
        if ( options.dependent ) {
          return this.querySelector("dependentfield")._dependentMatch();
        } else {
          return true;
        }
      }
  ...
  options.id = options.id + "_" + primaryTypeKey;
