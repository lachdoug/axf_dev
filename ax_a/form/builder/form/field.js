AxFunctionExtensionsFormBuilder.prototype.field = function(
  name,
  typeOrOptions,
  valueOrOptions,
  fieldOptions
  ...
  [ primaryType, secondaryTypes, options ] = this.lib.parseFieldArgs( typeOrOptions, valueOrOptions, fieldOptions )
