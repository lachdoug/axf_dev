...
AxFunctionExtensionsFormBuilder.prototype.label = function(
  field, options={}
) {
// debugger
...
// debugger
        return a.label(
          a.innerwrapper(
            a.checklayout( [
              ...
              a.rightwrapper( this.lib.compactArray( [ labelBody, helpButton, hint, helpBody ] ), options.rightwrapper ),
            ] ),
      ...
      // var inlineOptions =  options.inline === true ? {} : options.inline || {}
        return a.label(
          a.innerwrapper(
            [
              a.leftwrapper( this.lib.compactArray( [ labelBody, helpButton ] ), options.leftwrapper ),
              a.rightwrapper( this.lib.compactArray( [ helpBody, field, hint ] ), options.rightwrapper ),
            ],
            options.innerwrapper
          ),
          attributes
