class App2 {
  ...
  constructor(a,x) {
    ...
    this.$nodes = x.appkit.form( (f) => [
      ...
      // f.field( { as: "richedit", dependent: null, placeholder: "Enter text here...", required: true, key: "mdwn1", value: "Fred", value: "Stuff" } ),
      f.field( { as: "code", dependent: null, placeholder: "Enter code here...", key: "script1", required: false, code: { mode: "javascript" } } ),
